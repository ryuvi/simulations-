...
function createBodies(num) {
	...
	for (let i = 0; i < num; i++) {
		let distance = random(50, 300); // Distância aleatória do sol (de 50 a 300)
		let speed = (k / distance) * 10; // Aumentando a velocidade multiplicando por 100 para um movimento mais visível
